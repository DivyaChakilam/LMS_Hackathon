...
public class DashboardSteps {
	...
	//@DashboardPage-01
		...
		public void admin_is_in_home_page() {
			System.out.println("Admin is in login page");
		}
		...
		public void admin_should_see_manage_program_as_header() {
			...
			assertEquals(valtext, "Manage Program", "Title do not match");
		...
		public void maximum_navigation_time_in_milliseconds_defaults_to_seconds(Integer expectedTimeoutSeconds) {
	        ...
	        if (isTimeoutCorrect) {
	            System.out.println("Timeout validation passed!");
	        } else {
	            System.out.println("Timeout validation failed!");
	            System.out.println("Expected Timeout (seconds): " + expectedTimeoutSeconds);
	            System.out.println("Actual Timeout (seconds): " + dashboardPage.getActualWaitTime());
	        }
		}
		...
		public void http_response_then_the_link_is_broken(Integer expectedResponsecode) throws MalformedURLException, IOException {
			int resCode = dashboardPage.actualResponseCode();
			//assertEquals(resCode,expectedResponsecode,"Response code matches, the above link is broken");
		...
		public void admin_should_see_program_in_the_1st_place() {
			...
			assertEquals(valtext, "Program", "Title matches ");
		}
		...
		public void admin_should_see_batch_in_the_2nd_place() {
			...
			assertEquals(valtext, "Batch", "Title matches ");
		}
		...
		public void admin_should_see_user_in_the_3rd_place() {
			...
			assertEquals(valtext, "User", "Title matches ");
		}
		...
		public void admin_should_see_logout_in_the_4th_place() {
			...
			assertEquals(valtext, "Logout", "Title matches ");
		}
